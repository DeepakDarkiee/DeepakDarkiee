...
class DeepakPatidar:
    ...
    website    = "deepakpatidar.in"
    articles   = "article.deepakpatidar.in"

    expertise  = [
        "LangChain · LangGraph · OpenAI APIs",
        "TensorFlow · PyTorch · HuggingFace",
        "Vector Databases (Pinecone · ChromaDB)",
        "Django · FastAPI · Celery · Microservices",
        "AWS (SageMaker · Lambda · EC2 · S3)",
        "MLOps · Docker · Kubernetes · CI/CD",
    ]

    currently  = "🔭 Building AI-powered production systems"
    learning   = "🌱 Advanced LLM agents & Agentic AI"
    passion    = "⚡ Solving hard problems with clean code"
    certified  = "☁️ AWS Certified (Cloud + ML)"
...
| Period | Role |
|--------|------|
| 🟢 **Dec 2023 – Present** | Senior Python Developer & AI Engineer |
| 🔵 **Apr 2021 – Dec 2023** | Senior Python Backend Developer |
| 🟣 **Mar 2020 – Apr 2021** | Python Developer |
| ⚪ **Apr 2019 – Mar 2020** | Junior Python Developer |
...
>
> — **Deepak Patidar** · Senior Python Developer & AI Engineer · Keep Rising 🚀
